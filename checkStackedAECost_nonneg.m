function [] = checkStackedAECost_nonneg()
...
[cost, grad] = stackedAECost_nonneg(stackedAETheta, inputSize, hiddenSize, ...
                             numClasses, netconfig, ...
                             lambda1, data, labels);

% Check that the numerical and analytic gradients are the same
numgrad = computeNumericalGradient( @(x) stackedAECost_nonneg(x, inputSize, ...
